    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(UriConstants.MOTORCYCLES_EDIT).hasAuthority("USER")
                        .pathMatchers(UriConstants.MOTORCYCLES_SEARCH_ME_ROUTES).hasAuthority("USER")
                        ...
                        .pathMatchers(UriConstants.ADMIN_ROUTES_MOTORCYCLES).hasAuthority("ADMIN")
                        .pathMatchers(UriConstants.AUCTIONS_ADD).hasAuthority("USER")
                        .pathMatchers(UriConstants.AUCTIONS_DELETE).hasAuthority("USER")
                        .pathMatchers(UriConstants.AUCTIONS_EDIT).hasAuthority("USER")
                        .pathMatchers(UriConstants.AUCTIONS_WS).hasAuthority("USER")
